...
import {NAVSHOW,GETMENULIST,GOCLIENTINFO,GETSEVENUSERNAME,SETCURRENTBRANDTOSHOP,GETBRANDLISTTOSHOP,GETBRANDLISTTOKEFU,SETCURRENTBRANDTOKEFU} from '../constants/index';
//导航缩放开关
...
export const setCurrentBrandToShop = (data = {}) => ({
    type: SETCURRENTBRANDTOSHOP,
    data: Object.assign({}, { ...data })
})
export const getBrandListToShop = () => dispatch => {
    return axios({
      method: 'post',
      url: '/hcm/userin/getBmcListByKefuid',
